...
namespace jDownloaderRemoteControlAPI
{
    ...
    public class jDownloaderRemoteControlAPI
    {
        ...
        public jDownloaderRemoteControlAPI(string Host, int Port)
        {
            ...
            string tmpHost = Host+":"+Port.ToString();
            if (!Host.EndsWith("/")) tmpHost += "/";
        ...
        #region Values
            ...
            public double Speed
            {
                ...
                {
                    string a = "get/speed/";
                    Remote r = new Remote(this._host + a, "GET");
        ...
        public void Update(){
            ...
            /// <summary>
            /// Set Downloadspeedlimit
            /// </summary>
            /// <param name="kbps"></param>
            public void SetDownloadSpeedLimit(int kbps)
            {
                string a = "action/set/download/limit/" + kbps.ToString();
                Remote r = new Remote(this._host + a, "GET");
                r.Response();
            }
            /// <summary>
